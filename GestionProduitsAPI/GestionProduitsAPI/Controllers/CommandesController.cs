...
namespace GestionProduitsAPI.Controllers
{
    ...
    public class CommandesController : ControllerBase
    {
        ...
        public CommandesController(GestionProduitsDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Commande>> PostCommande(Commande commande)
        {
            ...
            return CreatedAtAction("GetCommande", new { id = commande.OrderId }, commande);
        }
        ...
        {
            return _context.Commandes.Any(e => e.OrderId == id);
        }
    }
}
